...
public interface HistogramOrBuilder extends
   ...
   */
  java.util.List<io.opentelemetry.proto.metrics.v1.HistogramDataPoint> 
      getDataPointsList();
  /**
   * <code>repeated .opentelemetry.proto.metrics.v1.HistogramDataPoint data_points = 1;</code>
   */
   ...
   * <code>repeated .opentelemetry.proto.metrics.v1.HistogramDataPoint data_points = 1;</code>
   */
  java.util.List<? extends io.opentelemetry.proto.metrics.v1.HistogramDataPointOrBuilder> 
      getDataPointsOrBuilderList();
  /**
   * <code>repeated .opentelemetry.proto.metrics.v1.HistogramDataPoint data_points = 1;</code>
   */
  io.opentelemetry.proto.metrics.v1.HistogramDataPointOrBuilder getDataPointsOrBuilder(
      int index);
