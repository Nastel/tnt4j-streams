...
// source: prometheus/remote.proto
...
public final class Remote {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(prometheus.Remote.WriteRequest result) {
        if (timeseriesBuilder_ == null) {
      ...
      private void buildPartial0(prometheus.Remote.WriteRequest result) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                prometheus.Types.TimeSeries m =
                    input.readMessage(
                        prometheus.Types.TimeSeries.parser(),
                        extensionRegistry);
                if (timeseriesBuilder_ == null) {
                  ensureTimeseriesIsMutable();
                  timeseries_.add(m);
              ...
              case 26: {
                prometheus.Types.MetricMetadata m =
                    input.readMessage(
                        prometheus.Types.MetricMetadata.parser(),
                        extensionRegistry);
                if (metadataBuilder_ == null) {
                  ensureMetadataIsMutable();
                  metadata_.add(m);
  ...
  private static final long serialVersionUID = 0L;
        ...
        java.lang.Integer, prometheus.Remote.ReadRequest.ResponseType> acceptedResponseTypes_converter_ =
            new com.google.protobuf.Internal.ListAdapter.Converter<
              ...
              public prometheus.Remote.ReadRequest.ResponseType convert(java.lang.Integer from) {
                prometheus.Remote.ReadRequest.ResponseType result = prometheus.Remote.ReadRequest.ResponseType.forNumber(from);
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(prometheus.Remote.ReadRequest result) {
        if (queriesBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0)) {
      ...
      private void buildPartial0(prometheus.Remote.ReadRequest result) {
        int from_bitField0_ = bitField0_;
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                prometheus.Remote.Query m =
                    input.readMessage(
                        prometheus.Remote.Query.parser(),
                        extensionRegistry);
                if (queriesBuilder_ == null) {
                  ensureQueriesIsMutable();
                  queries_.add(m);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(prometheus.Remote.ReadResponse result) {
        if (resultsBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0)) {
      ...
      private void buildPartial0(prometheus.Remote.ReadResponse result) {
        int from_bitField0_ = bitField0_;
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                prometheus.Remote.QueryResult m =
                    input.readMessage(
                        prometheus.Remote.QueryResult.parser(),
                        extensionRegistry);
                if (resultsBuilder_ == null) {
                  ensureResultsIsMutable();
                  results_.add(m);
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(prometheus.Remote.Query result) {
        if (matchersBuilder_ == null) {
      ...
      private void buildPartial0(prometheus.Remote.Query result) {
        int from_bitField0_ = bitField0_;
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26: {
                prometheus.Types.LabelMatcher m =
                    input.readMessage(
                        prometheus.Types.LabelMatcher.parser(),
                        extensionRegistry);
                if (matchersBuilder_ == null) {
                  ensureMatchersIsMutable();
                  matchers_.add(m);
      ...
      public Builder mergeHints(prometheus.Types.ReadHints value) {
        if (hintsBuilder_ == null) {
          if (((bitField0_ & 0x00000008) != 0) &&
            hints_ != null &&
            hints_ != prometheus.Types.ReadHints.getDefaultInstance()) {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(prometheus.Remote.QueryResult result) {
        if (timeseriesBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0)) {
            timeseries_ = java.util.Collections.unmodifiableList(timeseries_);
            bitField0_ = (bitField0_ & ~0x00000001);
      ...
      private void buildPartial0(prometheus.Remote.QueryResult result) {
        int from_bitField0_ = bitField0_;
      }
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(prometheus.Remote.ChunkedReadResponse result) {
        if (chunkedSeriesBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0)) {
      ...
      private void buildPartial0(prometheus.Remote.ChunkedReadResponse result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000002) != 0)) {
          ...
          while (!done) {
            ...
            switch (tag) {
              case 0:
                ...
                break;
              case 10: {
                prometheus.Types.ChunkedSeries m =
                    input.readMessage(
                        prometheus.Types.ChunkedSeries.parser(),
                        extensionRegistry);
                if (chunkedSeriesBuilder_ == null) {
                  ensureChunkedSeriesIsMutable();
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\027prometheus/remote.proto\022\nprometheus\032\026p" +
      "rometheus/types.proto\032\024gogoproto/gogo.pr" +
      "oto\"z\n\014WriteRequest\0220\n\ntimeseries\030\001 \003(\0132" +
      "\026.prometheus.TimeSeriesB\004\310\336\037\000\0222\n\010metadat" +
      "a\030\003 \003(\0132\032.prometheus.MetricMetadataB\004\310\336\037" +
      "\000J\004\010\002\020\003\"\256\001\n\013ReadRequest\022\"\n\007queries\030\001 \003(\013" +
      "2\021.prometheus.Query\022E\n\027accepted_response" +
      "_types\030\002 \003(\0162$.prometheus.ReadRequest.Re" +
      "sponseType\"4\n\014ResponseType\022\013\n\007SAMPLES\020\000\022" +
      "\027\n\023STREAMED_XOR_CHUNKS\020\001\"8\n\014ReadResponse" +
      "\022(\n\007results\030\001 \003(\0132\027.prometheus.QueryResu" +
      "lt\"\217\001\n\005Query\022\032\n\022start_timestamp_ms\030\001 \001(\003" +
      "\022\030\n\020end_timestamp_ms\030\002 \001(\003\022*\n\010matchers\030\003" +
      " \003(\0132\030.prometheus.LabelMatcher\022$\n\005hints\030" +
      "\004 \001(\0132\025.prometheus.ReadHints\"9\n\013QueryRes" +
      "ult\022*\n\ntimeseries\030\001 \003(\0132\026.prometheus.Tim" +
      "eSeries\"]\n\023ChunkedReadResponse\0221\n\016chunke" +
      "d_series\030\001 \003(\0132\031.prometheus.ChunkedSerie" +
