...
import com.jkoolcloud.tnt4j.streams.custom.interceptors.kafka.reporters.metrics.MetricsReporter;
import com.jkoolcloud.tnt4j.streams.custom.interceptors.kafka.reporters.trace.MsgTraceReporter;
 ...
 * <ul>
 * <li>{@link com.jkoolcloud.tnt4j.streams.custom.interceptors.kafka.reporters.metrics.MetricsReporter} - to aggregate
 * and report Kafka metrics collected over interceptions and JMX to dedicated Kafka topic.</li>
 * <li>{@link com.jkoolcloud.tnt4j.streams.custom.interceptors.kafka.reporters.trace.MsgTraceReporter} - to trace
 ...
 * @version $Revision: 1 $
 *
 * @see com.jkoolcloud.tnt4j.streams.custom.interceptors.kafka.reporters.metrics.MetricsReporter
 * @see com.jkoolcloud.tnt4j.streams.custom.interceptors.kafka.reporters.trace.MsgTraceReporter
 */
public class InterceptionsManager {
	...
	private void loadProperties() {
		...
		try {
			...
			Utils.logThrowable(LOGGER, OpLevel.WARNING,
					...
					"InterceptionsManager.cfg.load.failed", interceptorsPropFile, exc);
		}
	}
	 ...
	 *
	 * @return {@code true} if interceptors references has any instance if {@link TNTKafkaPInterceptor} class,
	 ...
	 *
	 * @return {@code true} if interceptors references has any instance if {@link TNTKafkaCInterceptor} class,
	 *         {@code false} - otherwise
	 */
	...
	/**
	 * Notifies reporters that Kafka producer has acknowledged sent message.
	 *
	 * @param interceptor
