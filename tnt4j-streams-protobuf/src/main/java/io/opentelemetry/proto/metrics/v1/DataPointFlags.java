...
public enum DataPointFlags
   ...
   * </pre>
   *
   * <code>DATA_POINT_FLAGS_DO_NOT_USE = 0;</code>
   */
   ...
   * </pre>
   *
   * <code>DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK = 1;</code>
   */
   ...
   * <code>DATA_POINT_FLAGS_DO_NOT_USE = 0;</code>
   */
  public static final int DATA_POINT_FLAGS_DO_NOT_USE_VALUE = 0;
  /**
   * <pre>
   * This DataPoint is valid but has no recorded value.  This value
   * SHOULD be used to reflect explicitly missing data in a series, as
   ...
   * <code>DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK = 1;</code>
   */
  public static final int DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK_VALUE = 1;
  ...
  public static DataPointFlags forNumber(int value) {
    switch (value) {
      case 0: return DATA_POINT_FLAGS_DO_NOT_USE;
      case 1: return DATA_POINT_FLAGS_NO_RECORDED_VALUE_MASK;
      default: return null;
    }
  }
