...
public final class Types {
  ...
  private static final long serialVersionUID = 0L;
    ...
    @java.lang.Override public prometheus.Types.Histogram.ResetHint getResetHint() {
      prometheus.Types.Histogram.ResetHint result = prometheus.Types.Histogram.ResetHint.forNumber(resetHint_);
            ...
            switch (tag) {
              ...
              case 66: {
                prometheus.Types.BucketSpan m =
                    input.readMessage(
                        prometheus.Types.BucketSpan.parser(),
                        extensionRegistry);
                if (negativeSpansBuilder_ == null) {
                  ensureNegativeSpansIsMutable();
            ...
            switch (tag) {
              ...
              case 34: {
                prometheus.Types.Histogram m =
                    input.readMessage(
                        prometheus.Types.Histogram.parser(),
                        extensionRegistry);
                if (histogramsBuilder_ == null) {
                  ensureHistogramsIsMutable();
                  histograms_.add(m);
